Feature: As a user or administrator
  ...
  Scenario:
    ...
    And I click on "Edit"
    And I fill in field "Title" with "Another hilarious joke from Basketmouth"
    And I fill in field "Description" with "Basketmouth lashes Alibaba and his family"
    And I click on "Submit"
    Then I should see "Video successfully updated"
